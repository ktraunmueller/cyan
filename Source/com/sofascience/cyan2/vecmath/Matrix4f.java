 ...
 * Revision 1.2  2002/07/29 20:49:54  karl
 ...
 * Revision 1.1  2002/06/21 16:01:06  karl
 ...
 */
    ...
    protected Vector4f mV;
    protected Matrix4f mHelp;
  ...
  /**
    ...
    */
     ...
     *
     */
    public final void translateBy(Vector3f t) {
        /*
        if (mV == null)
            mV = new Vector4f();
        mV.set(t);
     ...
     *
     */
    public final void scaleBy(Vector3f s) {
        if (mHelp == null)
            mHelp = new Matrix4f();
        mHelp.setIdentity();
        mHelp.m00 = s.x;
     ...
     *
     */
    public final void rotateBy(Quat4f q) {
        if (mHelp == null)
            mHelp = new Matrix4f();
        mHelp.setIdentity();
        mHelp.setRotation(q);
